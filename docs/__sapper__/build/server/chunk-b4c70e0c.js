...
/* src/components/CodepenButton.svelte generated by Svelte v3.9.1 */
...
const CodepenButton = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { title = 'Svelma Example', code } = $$props;
...
/* src/components/Example.svelte generated by Svelte v3.9.1 */
...
const Example = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let { lang = 'xml', code, horizontal = false } = $$props;
	...
	return `<div class="${[`snippet svelte-150a96u`, horizontal ? "horizontal" : ""].join(' ').trim() }">
	  ${__chunk_1.validate_component(CodepenButton, 'CodepenButton').$$render($$result, { code: code }, {}, {
		default: () => `
	  ...
	  <div class="code svelte-150a96u">
	    ...
	    ${__chunk_1.validate_component(__chunk_4.Codeview, 'Code').$$render($$result, { lang: lang, code: code }, {}, {})}
...
//# sourceMappingURL=chunk-b4c70e0c.js.map
