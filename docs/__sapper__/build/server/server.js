...
var index = require('./index-18a86658.js');
require('./chunk-64057023.js');
require('clipboard');
var __chunk_4 = require('./chunk-e9912fa5.js');
require('./chunk-b4c70e0c.js');
require('./chunk-fa327f52.js');
var notification = require('./notification-51f5d9fa.js');
var collapse = require('./collapse-b9458205.js');
var progress = require('./progress-085e3aa3.js');
var snackbar = require('./snackbar-b3e3d5c3.js');
var message = require('./message-0a6f4c75.js');
var button = require('./button-4b8ba6e9.js');
var dialog = require('./dialog-8b3bd52a.js');
var _switch = require('./switch-e8e0b8b5.js');
var field = require('./field-18ddb5be.js');
var input = require('./input-2bced44f.js');
var modal = require('./modal-8c322015.js');
var toast = require('./toast-ab58722a.js');
var icon = require('./icon-c9e75940.js');
var tabs = require('./tabs-6efe09fe.js');
var index$1 = require('./index-a4e35623.js');
var about = require('./about-1c0f3654.js');
var intro = require('./intro-0f7344e8.js');
var media = require('./media-e6dd70ee.js');
var table = require('./table-a049fab9.js');
var tiles = require('./tiles-9167721b.js');
var hero = require('./hero-4745bf77.js');
var index$2 = require('./index-0bdc6b54.js');
var _slug_ = require('./[slug]-cf5edc74.js');
...
const Nav = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const rootUrl = '/svelma';
	...
	<nav id="navbar" class="navbar has-shadow is-spaced">
	  <div class="container">
	    <div class="navbar-brand svelte-19nr2rz">
	  ...
	  <ul class="svelte-1o002vm">
	    ${__chunk_1.each(components, (c) => `<li class="svelte-1o002vm">
	        ${ c === 'Form' ? `<p>${__chunk_1.escape(c)}</p>
	          ...
	          </ul>` : `<a href="components/${__chunk_1.escape(c.toLowerCase())}">${__chunk_1.escape(c)}</a>` }
	      </li>`)}
