...
/* src/routes/bulma/media.svelte generated by Svelte v3.9.1 */
	  ...
	  `,
	    ...
	    <div class="box">
	      <article class="media">
	        <div class="media-left">
	          <figure class="image is-64x64">
	            ${ user ? `<img class="is-rounded"${__chunk_1.add_attribute("src", user.picture.medium, 0)} alt="Profile picture">` : `` }
	          </figure>
	        </div>
	        <div class="media-content">
	          <div class="content">
	          ...
	          ${ user ? `<nav class="level is-mobile">
	              <div class="level-left">
	                <a href class="level-item" aria-label="reply">
	                  <span class="icon is-small">
...
//# sourceMappingURL=media-e6dd70ee.js.map
