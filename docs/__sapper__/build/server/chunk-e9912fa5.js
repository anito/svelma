...
/* src/components/Code.svelte generated by Svelte v3.9.1 */
...
const Code = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	

  let { lang = 'js', code = '', showCopy = true } = $$props;
  let button;
  let codeElm;
  let clip;
  let show = false;
  ...
  __chunk_1.onDestroy(() => {
	...
	return `<div class="codeview svelte-1ccczge">
	  <figure class="highlight is-expanded svelte-1ccczge">
	    ${ showCopy ? `<div class="button-container svelte-1ccczge">
	        <button class="button is-text is-small copy-code"${__chunk_1.add_attribute("this", button, 1)}>Copy</button>
	      </div>` : `` }
	    <pre class="hidden svelte-1ccczge">
	      <code class="${__chunk_1.escape(__chunk_1.null_to_empty(lang))} svelte-1ccczge"${__chunk_1.add_attribute("this", codeElm, 1)}>
...
exports.Codeview = Code;
exports.commonjsGlobal = commonjsGlobal;
exports.createCommonjsModule = createCommonjsModule;
exports.unwrapExports = unwrapExports;
//# sourceMappingURL=chunk-e9912fa5.js.map
