import { c as SvelteComponentDev, d as init, b as safe_not_equal, e as dispatch_dev, t as globals, C as create_component, G as space, D as claim_component, H as claim_space, E as mount_component, n as insert_dev, A as transition_in, y as transition_out, F as destroy_component, i as detach_dev, f as element, g as claim_element, h as children, j as attr_dev, k as add_location, o as append_dev, a as noop, R as text, S as claim_text } from './chunk.0f951886.js';
import { d as Button, h as Snackbar } from './chunk.b9034416.js';
...
const file = "src/routes/components/snackbar.svelte";

// (57:6) <Button on:click={open}>
function create_default_slot_4(ctx) {
	let t;

	const block = {
		c: function create() {
			t = text("Default Snackbar");
		},
		l: function claim(nodes) {
			t = claim_text(nodes, "Default Snackbar");
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(57:6) <Button on:click={open}>",
		ctx
	});
...
// (58:6) <Button type="is-success" on:click={() => open({ message: 'Success', type: 'is-success', position: 'is-bottom-left', duration: 1000 })}>
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(58:6) <Button type=\\\"is-success\\\" on:click={() => open({ message: 'Success', type: 'is-success', position: 'is-bottom-left', duration: 1000 })}>",
		ctx
	});
...
// (59:6) <Button type="is-danger" on:click={() => open({ message: 'Danger', type: 'is-danger', actionText: 'retry', position: 'is-top-left' })}>
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(59:6) <Button type=\\\"is-danger\\\" on:click={() => open({ message: 'Danger', type: 'is-danger', actionText: 'retry', position: 'is-top-left' })}>",
		ctx
	});
...
// (60:6) <Button type="is-primary" on:click={() => open({ message: 'Customized Background', background: 'has-background-grey-lighter', position: 'is-bottom'  })}>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(60:6) <Button type=\\\"is-primary\\\" on:click={() => open({ message: 'Customized Background', background: 'has-background-grey-lighter', position: 'is-bottom'  })}>",
		ctx
	});
...
function create_preview_slot(ctx) {
	...
	button1.$on("click", /*click_handler*/ ctx[1]);
	...
	button2.$on("click", /*click_handler_1*/ ctx[2]);
	...
	button3.$on("click", /*click_handler_2*/ ctx[3]);
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div1, "class", "buttons svelte-nm7qtc");
			add_location(div1, file, 55, 4, 2241);
			attr_dev(div0, "slot", "preview");
			add_location(div0, file, 54, 2, 2216);
		},
		m: function mount(target, anchor) {
...
// (41:0) <Example code={`<script>   import { Button, Snackbar } from 'svelma'    function open(props) {     let defaults = { message: 'I am a Snackbar' }     props = Object.assign(defaults, props)     Snackbar.create(props)   } </script>  <Button on:click={open}>Default Snackbar</Button> <Button type="is-success" on:click={() => open({ message: 'Success', type: 'is-success', position: 'is-bottom-left', duration: 1000 })}>Successs</Button> <Button type="is-danger" on:click={() => open({ message: 'Danger', type: 'is-danger', actionText: 'retry', position: 'is-top-left' })}>Top Left</Button> <Button type="is-primary" on:click={() => open({ message: 'Customized Background', background: 'has-background-grey-lighter', position: 'is-bottom'  })}>Custom Background</Button>`}>
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(41:0) <Example code={`<script>   import { Button, Snackbar } from 'svelma'    function open(props) {     let defaults = { message: 'I am a Snackbar' }     props = Object.assign(defaults, props)     Snackbar.create(props)   } </script>  <Button on:click={open}>Default Snackbar</Button> <Button type=\\\"is-success\\\" on:click={() => open({ message: 'Success', type: 'is-success', position: 'is-bottom-left', duration: 1000 })}>Successs</Button> <Button type=\\\"is-danger\\\" on:click={() => open({ message: 'Danger', type: 'is-danger', actionText: 'retry', position: 'is-top-left' })}>Top Left</Button> <Button type=\\\"is-primary\\\" on:click={() => open({ message: 'Customized Background', background: 'has-background-grey-lighter', position: 'is-bottom'  })}>Custom Background</Button>`}>",
		ctx
	});
...
function instance($$self, $$props, $$invalidate) {
	...
	return [jsdoc, click_handler, click_handler_1, click_handler_2];
}
...
class Snackbar_1 extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*jsdoc*/ ctx[0] === undefined && !("jsdoc" in props)) {
			console.warn("<Snackbar> was created without expected prop 'jsdoc'");
		}
	}
